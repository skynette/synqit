...
export function UnlockWeb3Section() {
    return (
        <section className="w-full py-4 md:py-32 relative overflow-hidden">
            <div className="unlock-oval-border border border-synqit-border/60 px-4 md:px-8 py-8 md:py-16 max-w-xs w-full md:max-w-7xl mx-auto overflow-hidden flex flex-col items-center justify-center">
