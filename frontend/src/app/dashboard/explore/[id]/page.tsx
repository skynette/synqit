        ...
        <div className="lg:col-span-1">
          <div className="bg-synqit-surface/50 backdrop-blur-sm border border-synqit-border rounded-2xl p-6 space-y-6">
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center gap-6 mb-4">
                <div className="flex items-center gap-1 text-synqit-muted-foreground">
                  ...
                  <span className="text-xs text-synqit-muted-foreground">
                    Trust Score
                  </span>
                </div>
                <div className="flex items-center gap-1 text-synqit-muted-foreground">
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                <p className="text-sm text-synqit-muted-foreground">
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={
                  isRequestingPartnership || !project.isLookingForPartners
                }
          ...
          <div className="bg-synqit-surface/50 backdrop-blur-sm border border-synqit-border rounded-2xl p-6 mt-6">
            ...
            <div className="space-y-3">
              ...
              {project.teamSize && (
                <div className="flex justify-between">
                  <span className="text-synqit-muted-foreground">
                    Team Size:
                  </span>
        ...
        <div className="lg:col-span-2 space-y-8">
              ...
              <div className="space-y-3">
                {project.website && (
                  <div className="flex items-center gap-3">
                    <svg
                      className="w-5 h-5 text-synqit-primary"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
          ...
          <div className="bg-synqit-surface/50 backdrop-blur-sm border border-synqit-border rounded-2xl p-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-synqit-muted-foreground mb-6">
                Connect with {project.name} and explore partnership
                opportunities in the {project.projectType} space.
              </p>
