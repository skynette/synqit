    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-1">
                <p className="text-synqit-muted-foreground text-sm italic">Refining Results...</p>
                ...
                <div className="relative">
                    <div className="flex items-start gap-4 overflow-x-auto scrollbar-hide pb-2">
                        <div className="flex gap-3 flex-nowrap">
                            ...
                            <div className="min-w-[180px]">
                                ...
                                <select 
                                    ...
                                    className="w-full bg-synqit-surface border border-synqit-border rounded-lg px-4 py-2.5 text-white text-sm focus:outline-none focus:ring-2 focus:ring-synqit-primary"
                                >
                            ...
                            {/* Project Stage */}
                            <div className="min-w-[180px]">
                                <label className="block text-white text-sm font-medium mb-2">Project Stage</label>
                                <select 
                            ...
                            {/* Blockchain Network */}
                            <div className="min-w-[180px]">
                                <label className="block text-white text-sm font-medium mb-2">Blockchain Network</label>
                                <select 
                            ...
                            {/* Token Availability */}
                            <div className="min-w-[180px]">
                                <label className="block text-white text-sm font-medium mb-2">Token Availability</label>
                                <select 
                            ...
                            {/* Reward Model */}
                            <div className="min-w-[180px]">
                                <label className="block text-white text-sm font-medium mb-2">Reward Model</label>
                                <select 
                            ...
                            {/* Funding Status */}
                            <div className="min-w-[180px]">
                                <label className="block text-white text-sm font-medium mb-2">Funding Status</label>
                                <select 
                            ...
                            {/* Main Focus */}
                            <div className="min-w-[180px]">
                                <label className="block text-white text-sm font-medium mb-2">Main Focus</label>
                                <select 
                        ...
                        <div className="flex gap-3 items-end flex-shrink-0 ml-4">
                            <button className="bg-synqit-primary hover:bg-synqit-primary/80 text-white px-5 py-2.5 rounded-lg font-medium text-sm transition-colors whitespace-nowrap">
                                Apply Filter
                            </button>
                            <button className="bg-synqit-muted hover:bg-synqit-muted/80 text-white px-5 py-2.5 rounded-lg font-medium text-sm transition-colors flex items-center gap-2 whitespace-nowrap">
                                Clear Filter
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                {partners.map((partner) => (
                    <div key={partner.id} className="bg-synqit-surface/50 backdrop-blur-sm border border-synqit-border rounded-2xl overflow-hidden flex flex-col hover:border-synqit-accent/20 transition-colors">
                        {/* Banner Image */}
                        ...
                        <div className="p-5 flex flex-col flex-grow">
                                ...
                                <div className="flex -space-x-2">
                                    ...
                                    {partner.partnerAvatars.length > 6 && (
                                        <div className="w-6 h-6 rounded-full bg-synqit-muted border-2 border-synqit-surface flex items-center justify-center">
                                            <span className="text-[10px] text-synqit-muted-foreground">+{partner.partnerAvatars.length - 6}</span>
                                        </div>
                                    )}
                                </div>
                            </div>
                            ...
                            {/* View Details Button */}
                            <button className="w-full py-3 bg-synqit-primary/20 hover:bg-synqit-primary/60 text-white rounded-lg transition-colors duration-200 font-medium text-sm">
                                View Details
                            </button>
                        </div>
                    </div>
